...
export default function ContentList({ animeList, loading, error, page, handleHideClick, hiddenAnime, handleNextPage, handlePrevPage }) {
    ...
    function handleWatchClick(title) {
                            ...
                            <div key={anime.mal_id}>
                                ...
                                <div className="card-body text-left">
                                    <div className="flex flex-row">
                                        ...
                                        {/** Want to add copy button then uncomment this and style it
                                            <Button className="ml-auto" onClick={() => handleCopyTitle(anime.title)} text={"📋 Copy Title"} /> */}
                                        {/** Watch button */}
                                        <Button className="ml-auto" onClick={() => handleWatchClick(anime.title)} text={"🎬 Watch"} />
                                    </div>
